...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, PBOOST_EN_Pin|PSEPIC_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PBOOST_EN_Pin PSEPIC_EN_Pin */
  GPIO_InitStruct.Pin = PBOOST_EN_Pin|PSEPIC_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : IO_SDMMC_CD_Pin USB_SENSE_Pin */
  GPIO_InitStruct.Pin = IO_SDMMC_CD_Pin|USB_SENSE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
